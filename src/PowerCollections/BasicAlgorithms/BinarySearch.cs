...
namespace Wintellect.PowerCollections.BasicAlgorithms
{
    ...
    */
    ...
    {
        /// <summary>
        ///  二分查找算法 ： int[] ArrayToSort = new int[] { 11, 22, 33, 44, 55, 66 };
        /// </summary>
        /// <param name="sortedList"></param>
        /// <param name="element"></param>
        /// <returns></returns>
        public static int BinarySearchArray(int[] sortedList, int element)
        {
            int startPosition = 0;
            ...
            while (startPosition < endPosition)
            {
                ...
                if (element > midElementValue)
                {
                    //Found element in right half.
                    startPosition = ++midIndex;
                }
                else if (element < midElementValue)
                {
